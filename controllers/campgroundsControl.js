...
module.exports.index = async (req, res) => {
    ...
    res.render('campgrounds/index.ejs', { campgrounds, page_name: "all camps" })
}

module.exports.renderNewForm = (req, res) => {
    res.render('campgrounds/new.ejs', { page_name: "new camp" });
}
...
module.exports.showCampground = async (req, res) => {
    ...
    res.render('campgrounds/show.ejs', { camp, page_name: "show camp" })
}
...
module.exports.renderEditForm = async (req, res) => {
    ...
    res.render('campgrounds/edit.ejs', { camp, page_name: "edit camp" })
}
